...
require("lsp-format").setup {
  ...
  lua = { { cmd = {
    function()
      return string.format('lua-format i --no-keep-simple-function-one-line --no-spaces-inside-functiondef-parens --break-after-table-lb --no-spaces-inside-functioncall-parens --indent-width=2 %s')
    end
  } } },
  rust = { { cmd = { "prettier -W" } } },
